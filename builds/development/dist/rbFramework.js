...
angular.module('app').directive('rbLetterpress', function(){
    ...
    link: function(scope, el, attr, ctrl){
      ...
      scope.device = 'thank-you';
      
      scope.isThankYou = function(){
        scope.device = 'thank-you';
      };
